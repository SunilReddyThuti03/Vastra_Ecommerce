            ...
            {cart?.products?.length > 0 && (
                ...
                <div className='sticky p-4 bottom-0 bg-white'>
                    <button 
                        ...
                        className='w-full rounded-full py-3 font-semibold bg-black text-white
                            hover:bg-gray-800 transition'>Checkout</button>
                        <p className='text-sm tracking-tighter text-gray-500 mt-2 text-center'>
                            Shipping, taxes, and discount codes calulated at checkout.
                        </p>
                </div>
                </>
            )}
