...
const FilterSideBar = () => {
    ...
    const materials =[
        "Cotton", "Wool","Polyster","Silk","Lenin","Denim","Viscose","Fleece"
    ];

    const brands=["Urban Threads", "Heritage Wear", "Street Vibes",
            "Beach Breeze", "Polo Classics", "Urban Chic","Winter Basics"
    ];
            ...
            <div className='flex flex-wrap gap-2'>
            {
                colors.map((color)=>(
                        <button 
                            ...
                            className={`w-8 h-8 rounded-full cursor-pointer transition hover:scale-120 ${filters.color === color? "ring-2 ring-blue-500 " : " "}`}  />
